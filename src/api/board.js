...
// 팀장만 호출 가능 (Claude.md "팀장 권한 판정") — 팀장이 아니면 403 NOT_TEAM_LEADER.
...
// TODO: 보드판 조회 GET 엔드포인트 경로가 Claude.md에 아직 명시 안 됨.
export function getBoard() {
  throw new Error("getBoard: API 경로 미정 (Claude.md에 명세 추가 필요)");
}
